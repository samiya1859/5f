...
def add_destination_service(data, admin_email):
    ...
    if not name or not description or not location or not price:
        return {"message": "All fields are required"}, 400

    # Create a new Destination instance
    new_destination = Destination(name, description, location, price, admin_email)
...
destinations = {
    "1": {"id": "1", "name": "Paris", "description": "The city of lights.", "location": "France", "price": 1500},
    "2": {"id": "2", "name": "Maldives", "description": "Tropical paradise.", "location": "Indian Ocean", "price": 3000},
}
